#--------------------------------------------------------------------------------------
#
#     $Source: DgnV8Conversion/BulkDgnV8Conversion.py $
#
...
def recursive_converter(dgn_exe_path, dgn_args_dict, folder_path, output_path, report_lock, ls_files, custom_check, ls_files_counter):
    '''
        A Recursive code for visiting all the folder in path, and access all the dgn files in it.
